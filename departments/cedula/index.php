...
$sql = "SELECT * FROM tbl_cedula where DATE = '$date' order by ID ASC limit 1";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') { 
    ...
    $sql = "UPDATE docu_table set cedula = 0 WHERE user_id = '$queue_id' order by docu_table_id DESC limit 1";
