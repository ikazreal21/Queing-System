...
$sql = "SELECT * FROM tbl_indigency where DATE = '$date' order by ID ASC limit 1";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') { 
    $sql = "INSERT INTO tbl_records(Department,DATE,TIME,fullname,User_id) VALUES ('Indigency','$date','$time','$fullname','$queue_id')";
    $insert = $conn->query($sql);

    $sql = "INSERT INTO tbl_indrecords(Department,DATE,TIME,User_id,user_first_name) VALUES ('Indigency','$date','$time','$queue_id','$first_name')";
    $insert = $conn->query($sql);

    $sql = "DELETE FROM tbl_indigency WHERE  DATE = '$date' order by ID ASC limit 1";
    $delete = $conn->query($sql);
    
    $sql = "UPDATE docu_table set indigency = 0 WHERE user_id = '$queue_id' order by docu_table_id DESC limit 1";
    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="">Indigency</a>
            </div>
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="indrec.php">Indigency Records</a>
                    </li>
                </ul>
        ...
        <div id="page-wrapper">
            <div id="page-inner" class="bg-image">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Indigency</h1>
                    </div>
                </div>
