...
$sql = "SELECT * FROM tbl_policeclr plc, docu_table dc where DATE = '$date' and plc.User_id = dc.user_id  order by ID ASC limit 1";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $sql = "INSERT INTO tbl_records(Department,DATE,TIME,fullname,User_id) VALUES ('Police Clearance','$date','$time','$fullname','$queue_id')";
    $insert = $conn->query($sql);

    $sql = "INSERT INTO tbl_pcrecords(Department,DATE,TIME,User_id,user_first_name) VALUES ('Police Clearance','$date','$time','$queue_id','$first_name')";
    $insert = $conn->query($sql);
    ...
    <div id="wrapper">
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="pcrec.php">Police Clearance Records</a>
                    </li>
                </ul>
        ...
        <div id="page-wrapper">
            <div id="page-inner" class="bg-image">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Police Clearance</h1>
                    </div>
                </div>
